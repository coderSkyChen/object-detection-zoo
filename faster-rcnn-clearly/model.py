...
class _ProposalLayer(nn.Module):
    ...
    def forward(self, input):
        ...
        anchors = self._anchors.view(1, A, 4) + shifts.view(K, 1, 4)  # [1,9,4]+[1850,1,4]=[1850,9,4]
        anchors = anchors.view(1, K * A, 4).expand(batch_size, K * A, 4)  # [bs,A*K,4]
        ...
        for i in range(batch_size):
            ...
            if pre_nms_topN > 0 and pre_nms_topN < scores_keep.numel():  # per_nms_topN 12000,  scores_keep.numel() = 33300
...
class _AnchorTargetLayer(nn.Module):
    ...
    def forward(self, input):
        ...
        if self.args.RPN_POSITIVE_WEIGHT < 0:
...
class _RPN(nn.Module):
    ...
    def forward(self, base_feat, im_info, gt_boxes, num_boxes):
        ...
        if self.training:
            ...
            rpn_cls_score = rpn_cls_score_reshape.permute(0, 2, 3, 1).contiguous().view(batch_size, -1,
                                                                                        2)  # [2*16650*2]
