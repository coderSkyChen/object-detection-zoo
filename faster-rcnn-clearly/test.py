...
if __name__ == '__main__':
    ...
    imdb, roidb, ratio_list, ratio_index = combined_roidb(args.imdbval_name, args, False)
    ...
    if args.net == 'vgg16':
        fasterRCNN = vgg16(imdb.classes, pretrained=False, class_agnostic=args.class_agnostic, args=args)
    else:
    ...
    dataset = roibatchLoader(roidb, ratio_list, ratio_index, args.batch_size, \
                             imdb.num_classes, training=False, normalize=False, args=args)
